...
| Space Partition | When overriding the project settings, use these space partition settings instead. See [space parition settings](Space-Partition#space-partition-settings) for details. |
