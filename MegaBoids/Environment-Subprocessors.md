...
| :------------ | :---------- | :----------  |
| Constant | Constant force applied to the boids at all times.<br><br>**<ins>Properties</ins>**<br>_Forces_: List of world space forces to apply. | [![Constant Environment Preview](/assets/images/MegaBoids/ConstantEnvironmentPreview.png)](/assets/images/MegaBoids/ConstantEnvironmentPreview.png) |
