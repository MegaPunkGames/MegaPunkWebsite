...
![Data Asset Preview2](/assets/images/MegaBoids/DataAssetPreview2.png)
...
![Specialized Driving Subprocessors](/assets/images/MegaBoids/SpecializedDrivingSubprocessors.png)
...
| Trigger   | Details     |        |
| :-------- | :---------- | :----- | 
| Delay | Waits for a random amount of time to pass before triggering once.<br><br>**<ins>Properties</ins>**<br>_Min/Max Delay_: Range of time to randomly wait. | [![Delay Trigger Preview](/assets/images/MegaBoids/DelayTriggerPreview.png)](/assets/images/MegaBoids/DelayTriggerPreview.png) |
